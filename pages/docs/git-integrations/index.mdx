...
export const meta = {
  ...
  lastEdited: '2020-08-18T23:08:08.000Z',
}
...
Deploying Git submodules are supported as long as they are publically accessible and are accessed via the HTTP protocol.
Git submodules that are private or requested over SSH will fail to get retrieved.
